...
def suave_exp_vs_rec_vals(grad_dim, m, b, path_to_mocks_dir, mock_name):
    ...
    fig.savefig(os.path.join(path_to_mocks_dir, f"suave/plots/recovered_grad/recovered_grad_{mock_name}.png"))
    plt.cla()
